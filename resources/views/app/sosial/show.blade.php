                    ...
                    <div class="app-card-body p-3">
                        ...
                        <table class="table app-table-hover mb-0 text-left">
                                ...
                                <tr>
                                    ...
                                    <td class="cell" style="font-weight: 700" width="70%">: {{ ucwords($data->kategori) }}</td>
                                </tr>
                                <tr>
                                    <th class="cell" style="font-weight: 900" width="30%">Jumlah</th>
                                    <td class="cell" style="font-weight: 700" width="70%">: Rp {{ number_format($data->jumlah) }}</td>
                                </tr>
                                <tr>
                                    <th class="cell" style="font-weight: 900" width="30%">Tanggal</th>
                                    <td class="cell" style="font-weight: 700" width="70%">: {{ date('d F Y', strtotime($data->tanggal)) }}</td>
                                </tr>
                                <tr>
                                    <th class="cell" style="font-weight: 900" width="30%">Keterangan</th>
                                    <td class="cell" style="font-weight: 700" width="70%">: {{ ucwords($data->keterangan) }}</td>
                                </tr>
                                <tr>
                                    <th class="cell" style="font-weight: 900" width="30%">Bendahara</th>
                                    <td class="cell" style="font-weight: 700" width="70%">: {{ ucwords($data->bendahara->nama) }}</td>
                                </tr>
                                <tr>
                                    <th class="cell" style="font-weight: 900" width="30%">Bukti</th>
                                    <td class="cell" style="font-weight: 700" width="70%">:
                                        <a href="{{ asset('storage/' . $data->bukti) }}" target="_blank" rel="noopener noreferrer">
                                            <img src="{{ asset('storage/' . $data->bukti) }}" alt="" style="width: 100px; height: 100px; object-fit: cover; border-radius: 100%;">
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <div class="text-end">
                            <a href="{{ route('masjid.index') }}" class="btn btn-primary fw-bold text-white px-3 py-1 mt-3">Kembali</a>
                        </div>
